import { Token, WETH9, Price, CurrencyAmount } from '@ixswap1/sdk-core'
...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    ...
    expect(result).toEqual('0xe729b1c1A859dB4b7EbfE2b21EEa46253cb49AFe')
  })
...
describe('Pair', () => {
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0x9d9f8B6E0e0850643cf5c95Cd1BCc7F890Dbb7C0')
    })
  })
